  ...
  return (<div className="c-about-content">
    ...
    <div className="c-detail-section -content-padding">
      <div className="row">
        ...
        <div className="column small-12 medium-8">
          <p className="c-text -dark -fs-medium -fw-light">Financing Sustainable Cities is an initiative of focused on <strong>helping cities develop business models</strong> that can accelerate the implementation of sustainable urban solutions.</p>
