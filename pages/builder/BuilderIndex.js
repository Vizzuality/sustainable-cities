...
class BuilderIndex extends React.Component {
  ...
  render() {
    const loading = !this.props.bmeTree.length;
        ...
        >
          ...
          <div className="u-ml-1">
            ...
            <ul>
              {
                (this.props.bmes || [])
                  .filter(bme => bme.enablings.find(enabling =>
                    enabling && enabling.id === this.state.hoveredEnabling))
