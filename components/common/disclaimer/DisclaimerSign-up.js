  ...
  render() {
    ...
    return (
      <section className="disclaimer">
        ...
        <p className="c-text">Welcome to the Beta version of the Financing Sustainable Cities Web Platform! Please feel free to explore the features that are currently available.</p>
