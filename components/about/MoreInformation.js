      ...
      <div className="row">
        ...
        <div className="column small-12 medium-8">
          <div className="content">
            ...
            <p className="c-text -dark -fs-medium -fw-light">For more information on the research method, please contact Anne Maassen, <a className="c-text -fs-medium -fw-light" href="mailto:amaassen@wri.org">amaassen@wri.org</a></p>
          </div>
        </div>
      </div>
    </div>
